...
return (
<section className='gap-5 transition-all w-full min-h-screen  bg-red-600 flex items-center justify-between p-8 py-10 flex-wrap flex-col overflow-hidden'>
    ...
    <div className="w-full text-center flex justify-self-start items-center flex-col md:flex-row  ">
        ...
        <div className="transition-all z-10 rounded-full relative w-full flex justify-center items-center flex-col md:flex-row opacity-100 p-4 gap-6  md:gap-12">
            ...
            <div className="w-full md:gap-4 flex items-center justify-center flex-row flex-wrap text-white tracking-widest text-xl  font-ultra !text-balance order-2 md:order-1">
            ...
            <div className="w-full gap-5 md:gap-12  flex items-center justify-center flex-row flex-wrap order-2 md:order-3 text-white text-3xl md:text-4xl lg:text-5xl">
