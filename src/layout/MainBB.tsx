    ...
    <section className='transition-all w-full min-h-screen  bg-red-600 flex items-center justify-between py-4 px-8 flex-wrap flex-col'>
        <div className="w-full flex gap-8 ">
            ...
            <div className="flex flex-col gap-2 md:gap-4 w-full justify-center">
                <div className="rounded md:rounded-xl h-1/6 bg-zinc-800 w-full"></div>
                <div className="rounded md:rounded-xl h-2/5 lg:h-3/6 bg-white w-full"></div>
            </div>
        </div>
        ...
        <div className="w-full text-center flex justify-between items-center flex-col md:flex-row ">
            ...
            <div className="z-10 rounded-xl  md:rounded-3xl md:left-1/2 md:-translate-x-1/2 relative md:absolute bg-red-500    md:w-5/6 md:h-24 w-12 h-96 flex justify-center ">
                <div className=" shadow-[0em_0.25em_rgba(0,0,0,0.15)] hover:shadow-[0em_1em_rgba(0,0,0,0.15)] group transition-all ease  bg-white rounded-full w-60 h-60 md:w-80 md:h-80 lg:w-96 lg:h-96 absolute top-1/2 -translate-y-[50%] hover:-translate-y-[calc(50%+15px)]  hover:drop-shadow-lg flex items-center justify-center ">
                    <div className="bg-red-600 rounded-full w-48 h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 flex items-center justify-center group-hover:animate-wiggle">
