    ...
    <div className="w-full text-center flex justify-between items-center flex-col md:flex-row ">
        ...
        <div className="transition-all z-10 rounded-full md:left-1/2 md:-translate-x-1/2 relative md:absolute bg-red-500 md:w-[0%] md:animate-expand md:h-24 w-16 h-[0rem] animate-expandOne flex justify-between items-center flex-col md:flex-row opacity-100 p-0">
            ...
            <div className="w-2/3 flex items-center justify-start gap-4 flex-col md:flex-row opacity-[inherit]">
                ...
                <FaMobile className="text-4xl md:text-5xl  scale-105 text-white transition-all cursor-pointer active:scale-110  hover:-translate-y-2 hover:drop-shadow-md"/> 

                <FaEnvelope className="text-4xl md:text-5xl lg:text-7xl text-white transition-all cursor-pointer active:scale-110  hover:-translate-y-2 hover:drop-shadow-md"/> 
            </div>

            <div className="opacity-0 cursor-pointer active:scale-105 animate-fallTen -top-[200%] shadow-[0em_0.25em_rgba(0,0,0,0.15)] hover:shadow-[0em_1em_rgba(0,0,0,0.15)] transition-all ease  bg-white  rounded-full w-72 h-72 md:w-80 md:h-80 lg:min-w-96 lg:min-h-96 absolute -translate-y-[50%] -translate-x-[50%] md:hover:-translate-y-[calc(50%+15px)]  md:hover:drop-shadow-lg flex justify-center left-1/2 items-center z-10 group ">
                <div className="bg-red-600 rounded-full w-56 h-56 md:w-64 md:h-64 lg:w-80 lg:h-80 flex items-center justify-center animate-wiggle relative ">
            ...
            <div className="w-2/3 flex items-center justify-end gap-4 flex-col md:flex-row">
                <FaLinkedin className="text-4xl md:text-5xl lg:text-7xl text-white transition-all cursor-pointer active:scale-110  hover:-translate-y-2 hover:drop-shadow-md "/> 

                <FaGithub className="text-4xl md:text-5xl lg:text-7xl text-white transition-all cursor-pointer active:scale-110  hover:-translate-y-2 hover:drop-shadow-md"/> 
            </div>
