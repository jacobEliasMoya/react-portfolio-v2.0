  ...
  return (
    <section className='transition-all w-full min-h-screen  bg-red-600 flex items-center justify-between py-4 px-8 flex-wrap flex-col overflow-hidden'>
        ...
        <div className="w-full text-center flex justify-between items-center flex-col md:flex-row ">
            ...
            <div className=" animate-grow [scale:0] opacity-0 bg-gradient-to-tr from-zinc-950 to bg-zinc-700 rounded-full w-36 h-36 m-w-36 m-h-36 md:w-52 md:h-52 md:m-w-52 md:m-h-52 lg:w-60 lg:h-60 lg:m-w-60 lg:m-h-60"></div>
            
            <div className="transition-all z-10 rounded-full md:left-1/2 md:-translate-x-1/2 relative md:absolute bg-red-500 md:w-[0%] md:animate-expand md:h-24 w-12 h-96 flex justify-center ">
                
                <div className="opacity-0 cursor-pointer animate-fallTen -top-[200%] shadow-[0em_0.25em_rgba(0,0,0,0.15)] hover:shadow-[0em_1em_rgba(0,0,0,0.15)] transition-all ease  bg-white rounded-full w-60 h-60 md:w-80 md:h-80 lg:w-96 lg:h-96 absolute -translate-y-[50%] hover:-translate-y-[calc(50%+15px)]  hover:drop-shadow-lg flex items-center justify-center ">
            ...
            <div className="animate-growOne [scale:0] opacity-0  bg-gradient-to-tr from-zinc-950 to bg-zinc-700 rounded-full w-36 h-36 m-w-36 m-h-36 md:w-52 md:h-52 md:m-w-52 md:m-h-52 lg:w-60 lg:h-60 lg:m-w-60 lg:m-h-60"></div>
