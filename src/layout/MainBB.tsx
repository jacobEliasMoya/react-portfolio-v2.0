...
<section className='transition-all w-full min-h-screen  bg-red-600 flex items-center justify-between p-8 py-10 flex-wrap flex-col overflow-hidden'>
    ...
    <div className="w-full text-center flex justify-between items-center flex-col md:flex-row my-8 md:my-auto">

        <div className="transition-all z-10 rounded-full md:left-1/2 md:-translate-x-1/2 relative md:bg-red-500 md:w-[0%] animate-expand md:max-w-[77%] md:h-24 w-16  flex justify-between items-center flex-col md:flex-row opacity-100 p-0 gap-8">

            <div className="w-2/3 flex items-center justify-center md:justify-start gap-4 flex-row opacity-[inherit]">
            ...
            <div className="opacity-0  active:scale-105 animate-fallTen -top-[200%] shadow-[0em_0.25em_rgba(0,0,0,0.15)] hover:shadow-[0em_1em_rgba(0,0,0,0.15)] transition-all ease  bg-red-500  rounded-full w-52 h-52 md:w-80 md:h-80 lg:min-w-96 lg:min-h-96 relative md:absolute md:-translate-y-[50%] md:-translate-x-[50%] md:hover:-translate-y-[calc(50%+15px)] md:hover:drop-shadow-lg flex justify-center md:left-1/2 items-center z-10 group ">
            ...
            <div className="w-2/3 flex items-center justify-center md:justify-end gap-4 flex-row">
