...
const Contact = (props:Props) => {
  ...
  return (
    ...
    <section id={props.id} className="relative origin-bottom transition-all ease-linear rounded-lg  duration-200 rounded-t-3xl bg-red-600 min-h-96 md: gap-8 md:gap-16 flex justify-between flex-wrap flex-col overflow-hidden pt-6 md:pt-10 px-6 md:px-8 pb-24 md:pb-28 " 
        style={{
