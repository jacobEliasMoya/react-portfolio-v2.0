...
const Contact = (props:Props) => {
  ...
  return (
    <section id={props.id} className="relative origin-bottom transition-all ease-out duration-300 rounded-t-[3rem] bg-red-600 min-h-96 md: gap-8 md:gap-16 flex justify-between flex-wrap flex-col overflow-hidden pt-10 md:pt-16 px-6 md:px-8 pb-24 md:pb-28" 
      style={{
