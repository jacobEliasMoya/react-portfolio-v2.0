...
const Contact = (props:Props) => {
  ...
  return (
    <section id={props.id} className="z-10 relative origin-bottom transition-all ease-out duration-300 rounded-t-[3rem] bg-red-800 min-h-96 md: gap-8 md:gap-16 flex justify-between flex-wrap flex-col overflow-hidden pt-10 md:pt-16 px-6 md:px-8 pb-24 md:pb-28" >
        ...
        <div className="grid lg:grid-cols-2 pb-4 font-ultra text-white gap-8 md:gap-12 lg:gap-24 items-start md:mx-11 text-center md:text-left ">
          ...
          <div className="grid justify-evenly flex-col gap-6 h-full order-1 lg:order-2">
            ...
            <Paragraph text={'I would love to get to know more about you, your businesses needs, and what exactly your looking for. '} classes={'gap-8 text-sm md:text-md lg:text-lg tracking-widest'}/>
