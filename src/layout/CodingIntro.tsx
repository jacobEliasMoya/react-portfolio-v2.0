    ...
    return (
        <section id={props.id} className='sticky top-0 origin-bottom transition-all ease-out duration-300 w-full min-h-screen   flex items-center justify-center p-6 md:p-8 py-6 md:py-10 flex-wrap flex-col rounded-b-3xl' >
            <div className="w-full text-center flex justify-center items-center flex-col md:flex-row  ">
                    <H3element additionalClasses={'text-4xl md:text-6xl lg:text-7xl flex flex-col text-center text-red-300 [word-spacing:10px] text-balance tracking-wide '} headerText={"Hi, I am Jacob Moya"} spanClasses={' text-white '} spanText={'View My Many Skills'}/>
            </div>
