...
const CodingIntro = (props:Props) => {
    ...
    return (
        <section id={props.id} className='-z-1 sticky top-0 origin-bottom transition-all ease-out duration-300 w-full min-h-screen   flex items-center justify-center p-6 md:p-8 py-6 md:py-10 flex-wrap flex-col rounded-b-3xl bg-gradient-to-br from-blue-900 to-blue-950' >
