...
const CodingLanguages = (props:Props) => {
    ...
    return (
            ...
            <section id={props.id} className="z-7 relative origin-right w-full rounded-3xl md:rounded-[3rem] bg-white flex justify-start flex-wrap flex-col overflow-hidden mx-auto pb-14 md:pb-24 pt-10 md:pt-16 px-6 md:px-8 transition-all ease-out duration-300 ">
