...
const ProfessionalExperience = () => {
    ...
    return (
        <section id="about" className="transition-all w-11/12 rounded-lg my-8 md:my-20 bg-white flex justify-start flex-wrap flex-col overflow-hidden mx-auto py-6 md:py-10 ">
            ...
            <div className="w-full gap-20 py-10 md:py-14 lg:py-18 font-ultra text-center md:text-left  grid grid-cols-4 mx-auto px-6 md:px-8 relative z-10">
                ...
                {initialResume?.map((item)=>(
                    <div className="col-span-full grid grid-cols-1 gap-8 ">
                        <div className="items-start grid grid-cols-1 md:grid-cols-2 gap-4 col-span-full md:col-span-3 ">
                            ...
                            <div className=" col-span-full gap-8 rounded grid grid-cols-8">

                                <div className="rounded col-span-full md:col-span-1 gap-4 flex items-center justify-center bg-zinc-800 ">
                                    <img src={item.experience.companyIcon} alt='' className="p-4 md:scale-110 brightness-0 md:-rotate-90 invert w-2/3"/>
                                </div>

                                <div className="grid grid-cols-1 col-span-full md:col-span-7 gap-2 md:gap-4 items-start justify-end flex-col">
                                    <H3element additionalClasses={' text-md md:text-3xl flex flex-col'} headerText={item.experience.companyName} spanClasses={undefined} spanText={undefined}/>
                                    ...
                                    <p className=" grid text-zinc-5600  items-start justify-start gap-8  md:text-xl">{item.experience.companyStartDate} - {item.experience.companyEndDate ? item.experience.companyEndDate : 'Still Kickin Butt'}</p>

                                    <p className="">{item.experience.smallExcerpt}</p>

                                    <ul className="grid gap-2 grid-cols-2 md:grid-cols-4 col-span-full  text-sm md:text-md xl:text-lg capitalize ">
