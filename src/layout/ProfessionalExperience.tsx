...
const ProfessionalExperience = (props:Props) => {
    ...
    return (
        ...
        <section id={props.id} className="z-3 relative origin-right w-full rounded-3xl md:rounded-[3rem] bg-white flex justify-start flex-wrap flex-col overflow-hidden mx-auto pt-10 pb-4 md:pb-10 transition-all ease-out  duration-300" >
